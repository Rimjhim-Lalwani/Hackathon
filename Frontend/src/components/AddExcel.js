...
export default function AddExcel({ addProductModalSetting, handlePageUpdate }) {
  ...
  const handleUpload = () => {
    ...
    reader.onload = function (e) {
      ...
      const filteredData = excelData.map((row) => {
        ...
        const expectedFields = ['name', 'manufacturer', 'description', 'stock'];
      ...
      fetch("http://localhost:4000/api/product/addFromExcel", {
        method: "POST",
        headers: {
